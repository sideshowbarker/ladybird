...
public:
    ...
    // Monotonic counter incremented by update_tree(). Consumers that cache derived data keyed on node
    // contents can compare against the generation they last computed at to know when a cache is stale.
