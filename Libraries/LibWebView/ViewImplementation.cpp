...
void ViewImplementation::insert_text_from_input_method(Utf16String const& text, size_t replace_before_caret_in_code_units)
{
    client().async_insert_text_from_input_method(page_id(), text, replace_before_caret_in_code_units);
}
